...
def main() -> int:
    ...
    if not args.skip_ollama:
        ...
        if not client.health():
            ...
            if not SETTINGS.qwen_narrator_model:
                ok = False
                print("QWEN_NARRATOR_MODEL is not configured")
            elif SETTINGS.qwen_narrator_model not in installed:
                print(
                    "WARNING: Qwen narrator model not listed exactly:",
                    SETTINGS.qwen_narrator_model,
                )
